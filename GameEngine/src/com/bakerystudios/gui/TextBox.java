...
public class TextBox {
	...
	public static void showPopUp(Graphics g, Font font, int y, String t1, String t2, Screen screen) {
		...
		int width = t2 == null ? fontWidth1 + 20 : fontWidth1 > fontWidth2 ? fontWidth1 + 20 : fontWidth2 + 20;
		int height = (int) (t2 == null ? fontHeight + 20 : fontHeight * 2 + 20);
		...
		if (t1 != null)
			drawCentralizedString(g, t1, y + 32, screen);
		if (t2 != null)
			drawCentralizedString(g, t2, y + 62, screen);
	}
	...
	public static void showDialog(Graphics g, Font font, String t1, String t2, String t3, boolean esc, boolean enter,
		...
		g.setColor(Color.BLACK);
		if (t1 != null)
			drawCentralizedString(g, t1, 580, screen);
		if (t2 != null)
			drawCentralizedString(g, t2, 610, screen);
		if (t3 != null)
			drawCentralizedString(g, t3, 640, screen);
